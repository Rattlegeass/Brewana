<template>
    ...
    <div class="card mb-10">
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-promo" url="/master/promo" :columns="columns"></paginate>
        </div>
    </div>
</template>
...
export default defineComponent({
    ...
    setup() {
        ...
        const { delete: deletePromo } = useDelete({
        ...
        const columns = [
            ...
            column.accessor("uuid", {
                ...
                cell: (cell) => h('div', { class: 'd-flex gap-2' }, [
                    ...
                    h('button', { class: 'btn btn-sm btn-icon btn-danger', onClick: () =>  deletePromo(`/master/promo/${cell.getValue()}`)
