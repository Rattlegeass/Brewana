<template>
    ...
    <div class="card mb-10">
        <div class="card-header align-items-center">
            <h2 class="mb-0">Daftar Kategori Barang</h2>
        ...
        <div class="card-body">
            <paginate ref="paginate" id="table-kategori" url="/master/kategori" :columns="columns"></paginate>
        </div>
    </div>
</template>
        ...
        const columns = [
            ...
            column.accessor("uuid", {
                ...
                cell: (cell) => h('div', { class: 'd-flex gap-2' }, [
                    ...
                    h('button', { class: 'btn btn-sm btn-icon btn-danger', onClick: () =>  deleteKategori(`/master/kategori/${cell.getValue()}`)
